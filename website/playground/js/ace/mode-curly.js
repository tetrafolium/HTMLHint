define("ace/mode/curly",
       [
         ...
         "ace/tokenizer", "ace/mode/matching_brace_outdent",
         "ace/mode/html_highlight_rules", "ace/mode/folding/html",
       ...
       function(e, t, n) {
         var r = e("../lib/oop"), i = e("./html").Mode,
             ...
             a = e("./folding/html").FoldMode,
             f = e("./curly_highlight_rules").CurlyHighlightRules,
             l = function() {
               var e = new f;
               this.$outdent = new o, this.foldingRules = new a,
                 ...
                 s = function() {
                   var e = {
                     ...
                     curly_mode :
                       ...
                       t = (new i).getRules();
                   t.start = e.start.concat(t.start),
                   t.curly_mode = e.curly_mode, this.$rules = t
                 };
