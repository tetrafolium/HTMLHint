define("ace/mode/haml",
       [
         ...
         "ace/tokenizer", "ace/mode/haml_highlight_rules",
    ...
    define(
        ...
        [
          ...
          "ace/mode/text_highlight_rules", "ace/mode/ruby_highlight_rules"
        ],
        function(e, t, n) {
          var r = e("../lib/oop"),
              i = e("./text_highlight_rules").TextHighlightRules,
              s = e("./ruby_highlight_rules"), o = s.RubyHighlightRules,
              u = function() {
                this.$rules = {
                  start : [
                  ...
                  section : [
                    s.constantOtherSymbol, s.qString, s.qqString, s.tString,
                    s.constantNumericHex, s.constantNumericFloat, {
                      token : "punctuation.section",
                      regex : "\\}",
                      next : "start"
