define("ace/mode/jsp",
       [
         ...
         "ace/tokenizer", "ace/mode/jsp_highlight_rules",
       ...
       function(e, t, n) {
         var r = e("../lib/oop"), i = e("./text").Mode,
             ...
             o = e("./jsp_highlight_rules").JspHighlightRules,
             u = e("./matching_brace_outdent").MatchingBraceOutdent,
             a = e("./behaviour/cstyle").CstyleBehaviour,
             f = e("./folding/cstyle").FoldMode, l = function() {
               var e = new o;
               this.$tokenizer = new s(e.getRules()), this.$outdent = new u,
               this.$behaviour = new a, this.foldingRules = new f
             };
         r.inherits(l, i), function() {}.call(l.prototype), t.Mode = l
       }),
    define(
        "ace/mode/jsp_highlight_rules",
        [
          "require", "exports", "module", "ace/lib/oop",
          "ace/mode/html_highlight_rules", "ace/mode/java_highlight_rules"
        ],
        function(e, t, n) {
          var r = e("../lib/oop"),
              ...
              o = function() {
                ...
                var t = "request|response|out|session|application|config|pageContext|page|Exception",
                    n = "page|include|taglib";
                this.embedRules(s, "jsp-"),
        ...
        function(e, t, n) {
          var r = e("../lib/oop"), i = e("../lib/lang"),
              ...
              d = function() {
                ...
                var v = i.copyArray(s);
                v.unshift(
                    {token : "comment", regex : ".*?\\*\\/", next : "media"});
                var m = i.copyArray(s);
                m.unshift(
    ...
    define("ace/mode/javascript_highlight_rules",
           ...
           function(e, t, n) {
             var r = e("../lib/oop"),
                 i = e("./doc_comment_highlight_rules")
                     ...
                     no_regex : [
                       ...
                       },
                       {
                         token : [
                           ...
                           "entity.name.function", "text", "paren.lparen"
                         ],
                         regex :
                             "(" + n + ")(\\.)(" + n +
                                 ")(\\s*)(=)(\\s*)(function)(\\s+)(\\w+)(\\s*)(\\()",
                       ...
                       {
                         token : [
                           "storage.type", "text", "entity.name.function",
                           "text", "paren.lparen"
                         ],
                       ...
                       {
                         token : [
                           "entity.name.function", "text",
                           "punctuation.operator", "text", "storage.type",
                           "text", "paren.lparen"
                         ],
                         regex :
                             "(" + n + ")(\\s*)(:)(\\s*)(function)(\\s*)(\\()",
