define("ace/mode/rhtml",
       [
         ...
         "ace/tokenizer", "ace/mode/rhtml_highlight_rules"
       ],
       function(e, t, n) {
         var r = e("../lib/oop"), i = e("./html").Mode,
             s = e("../tokenizer").Tokenizer,
             o = e("./rhtml_highlight_rules").RHtmlHighlightRules,
             u = function(e, t) {
    ...
    define("ace/mode/rhtml_highlight_rules",
           [
             "require", "exports", "module", "ace/lib/oop",
             "ace/mode/r_highlight_rules", "ace/mode/html_highlight_rules",
             "ace/mode/text_highlight_rules"
           ],
           function(e, t, n) {
             var r = e("../lib/oop"),
                 ...
                 u = function() {
                   this.$rules = (new s).getRules(), this.$rules.start.unshift({
                     token : "support.function.codebegin",
                     regex : "^<!--\\s*begin.rcode\\s*(?:.*)",
                     next : "r-start"
                   });
                   var e = (new i).getRules();
                   this.addRules(e, "r-"), this.$rules["r-start"].unshift({
