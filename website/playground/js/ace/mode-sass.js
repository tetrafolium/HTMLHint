define("ace/mode/sass",
       [
         ...
         "ace/tokenizer", "ace/mode/sass_highlight_rules",
         "ace/mode/folding/coffee"
       ],
       function(e, t, n) {
         var r = e("../lib/oop"), i = e("./text").Mode,
             s = e("../tokenizer").Tokenizer,
             o = e("./sass_highlight_rules").SassHighlightRules,
                       ...
                       (e.splice(
                            1, 1, {
                              onMatch : function(e, t, n) {
                                return n.unshift(this.next, -1, e.length - 2,
                                                 t),
                                       "comment"
                              },
                              regex : /^\s*\/\*/,
