define("ace/mode/pgsql",
       [
         ...
         "ace/tokenizer", "ace/mode/pgsql_highlight_rules", "ace/range"
       ],
       function(e, t, n) {
         var r = e("../lib/oop"), i = e("../mode/text").Mode,
             s = e("../tokenizer").Tokenizer,
             o = e("./pgsql_highlight_rules").PgsqlHighlightRules,
             u = e("../range").Range,
             a = function() { this.$tokenizer = new s((new o).getRules()) };
    ...
    define(
        ...
        [
          ...
          "ace/mode/text_highlight_rules", "ace/mode/perl_highlight_rules",
