define(
    ...
    function(e, t, n) {
      var r = e("../lib/oop"), i = e("./xml").Mode, s = e("./javascript").Mode,
          o = e("./css").Mode, u = e("../tokenizer").Tokenizer,
          a = e("./coldfusion_highlight_rules").ColdfusionHighlightRules,
          f = function() {
            i.call(this);
            var e = new a;
            this.$tokenizer = new u(e.getRules()), this.$embeds = e.getEmbeds(),
    ...
    define(
        ...
        [
          ...
          "ace/mode/text_highlight_rules", "ace/mode/xml_util"
        ],
        function(e, t, n) {
          var r = e("../lib/oop"),
              ...
              u = e("./xml_util"), a = function() {
                ...
                u.tag(this.$rules, "tag", "start"),
                u.tag(this.$rules, "style", "css-start"),
                u.tag(this.$rules, "script", "js-start"),
