...
var r = e("../lib/oop"), i = e("../worker/mirror").Mirror,
    s = e("./json/json_parse"),
    o = t.JsonWorker = function(e) { i.call(this, e), this.setTimeout(200) };
r.inherits(o, i), function() {
  this.onUpdate = function() {
    ...
    try {
      ...
      this.sender.emit(
          "error",
          {row : r.row, column : r.column, text : n.message, type : "error"});
      return
    }
    this.sender.emit("ok")
  }
...
t.stringTrimLeft = function(e) { return e.replace(r, "") },
    ...
    define("ace/mode/json/json_parse", [ "require", "exports", "module" ],
           function(e, t, n) {
var r, i,
    s = {
      '"' : '"',
    ...
    o, u = function(e) {
      ...
      return e && e !== i && u("Expected '" + e + "' instead of '" + i + "'"),
             i = o.charAt(r), r += 1, i
    }, f = function() {
      var e, t = "";
      i === "-" && (t = "-", a("-"));
...
return p = function() {
  ...
  var n;
  return o = e, r = 0, i = " ", n = p(), c(), i && u("Syntax error"),
         typeof t == "function" ? function s(e, n) {
           var r, i, o = e[n];
