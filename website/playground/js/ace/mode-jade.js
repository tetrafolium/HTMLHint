define("ace/mode/jade",
       [
         ...
         "ace/tokenizer", "ace/mode/jade_highlight_rules",
         "ace/mode/folding/coffee"
       ],
       function(e, t, n) {
         var r = e("../lib/oop"), i = e("./text").Mode,
             s = e("../tokenizer").Tokenizer,
             o = e("./jade_highlight_rules").JadeHighlightRules,
             u = e("./folding/coffee").FoldMode, a = function() {
               var e = new o;
               this.$tokenizer = new s(e.getRules()), this.foldingRules = new u
             };
         r.inherits(a, i),
             function() { this.lineCommentStart = "//" }.call(a.prototype),
             t.Mode = a
       }),
    define(
        ...
        [
          ...
          "ace/mode/text_highlight_rules", "ace/mode/markdown_highlight_rules",
        ...
        function(e, t, n) {
          function l(e, t) {
            return {
              token: "entity.name.function.jade", regex: "^\\s*\\:" + e,
                  next: t + "start"
            }
          }
          var r = e("../lib/oop"),
              ...
              c = function() {
                ...
                this.$rules = {
                  start : [
                    ...
                    l("markdown", "markdown-"), l("sass", "sass-"),
                    l("less", "less-"), l("coffee", "coffee-"), {
                      token : [
                  ...
                  tag_attributes : [
                    ...
                    {
                      token :
                          [ "entity.other.attribute-name.jade", "punctuation" ],
                      regex : "\\b([a-zA-Z:\\.-]+)(=)",
              ...
              o = function() {
                ...
                this.$rules = {
                  start : [
                    ...
                    {
                      token :
                          [ "support.function", "string", "support.function" ],
                      regex : "(url\\()(.*)(\\))"
                    },
                    {
                      token : function(i) {
