define("ace/mode/powershell",
       [
         ...
         "ace/tokenizer", "ace/mode/powershell_highlight_rules",
       ...
       function(e, t, n) {
         var r = e("../lib/oop"), i = e("./text").Mode,
             ...
             o = e("./powershell_highlight_rules").PowershellHighlightRules,
             ...
             f = e("./folding/cstyle").FoldMode, l = function() {
               ...
               this.$outdent = new u, this.$behaviour = new a,
               this.foldingRules =
                   new f({start : "^\\s*(<#)", end : "^[#\\s]>\\s*$"})
             };
              ...
              s = function() {
                var e = "function|if|else|elseif|switch|while|default|for|do|until|break|continue|foreach|return|filter|in|trap|throw|param|begin|process|end",
                    ...
                    n = this.createKeywordMapper(
                        {"support.function" : t, keyword : e}, "identifier"),
                    r = "eq|ne|ge|gt|lt|le|like|notlike|match|notmatch|replace|contains|notcontains|ieq|ine|ige|igt|ile|ilt|ilike|inotlike|imatch|inotmatch|ireplace|icontains|inotcontains|is|isnot|as|and|or|band|bor|not";
                this.$rules = {
                  start : [
                    {token : "comment", regex : "#.*$"},
