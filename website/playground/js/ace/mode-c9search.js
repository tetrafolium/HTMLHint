define("ace/mode/c9search",
       [
         ...
         "ace/tokenizer", "ace/mode/c9search_highlight_rules",
       ...
       function(e, t, n) {
         var r = e("../lib/oop"), i = e("./text").Mode,
             ...
             a = e("./folding/c9search").FoldMode, f = function() {
               this.$tokenizer = new s((new o).getRules()),
               this.$outdent = new u, this.foldingRules = new a
             };
                     ...
                     start : [
                       {
                         token : [
                           ...
                           "c9searchresults.text", "c9searchresults.text"
                         ],
                         regex : "(^\\s+[0-9]+)(:\\s*)(.+)"
                       },
    ...
    define("ace/mode/folding/c9search",
           ...
           function(e, t, n) {
             var r = e("../../lib/oop"), i = e("../../range").Range,
                 s = e("./fold_mode").FoldMode, o = t.FoldMode = function() {};
             r.inherits(o, s), function() {
               this.foldingStartMarker = /^(\S.*\:|Searching for.*)$/,
               this.foldingStopMarker = /^(\s+|Found.*)$/,
               this.getFoldWidgetRange = function(e, t, n) {
                 var r = e.doc.getAllLines(n), s = r[n],
