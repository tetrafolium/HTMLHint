define("ace/mode/glsl",
       [
         "require", "exports", "module", "ace/lib/oop", "ace/mode/c_cpp",
         "ace/tokenizer", "ace/mode/glsl_highlight_rules",
         "ace/mode/matching_brace_outdent", "ace/range",
         "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle"
       ],
       function(e, t, n) {
         var r = e("../lib/oop"), i = e("./c_cpp").Mode,
    ...
    define("ace/mode/c_cpp",
           [
             ...
             "ace/tokenizer", "ace/mode/c_cpp_highlight_rules",
             "ace/mode/matching_brace_outdent", "ace/range",
             "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle"
           ],
           function(e, t, n) {
             ...
             r.inherits(c, i), function() {
               ...
               this.autoOutdent = function(
                   e, t, n) { this.$outdent.autoOutdent(t, n) }
        ...
        function(e, t, n) {
          var r = e("../lib/oop"),
              ...
              s = function() {
                ...
                this.$rules.start.forEach(function(
                    e) { typeof e.token == "function" && (e.token = n) })
              };
