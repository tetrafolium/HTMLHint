define("ace/mode/latex",
       [
         ...
         "ace/tokenizer", "ace/mode/latex_highlight_rules",
       ...
       function(e, t, n) {
         var r = e("../lib/oop"), i = e("./text").Mode,
             ...
             u = e("./folding/latex").FoldMode, a = e("../range").Range,
             f = function() {
               this.$tokenizer = new s((new o).getRules()),
               this.foldingRules = new u
             };
         r.inherits(f, i),
             function() { this.lineCommentStart = "%" }.call(f.prototype),
             t.Mode = f
       }),
    define(
               ...
               this.getFoldWidgetRange = function(e, t, n) {
                 ...
                 var a = u.value, f = r[a],
                     l =
                       ...
                       return f === -1 &&
                                  (i.stepBackward(), t && i.stepBackward()),
                              t
                     },
                     c = [ l() ],
                     h = f === -1 ? i.getCurrentTokenColumn()
                                  : e.getLine(t).length,
                     p = t;
