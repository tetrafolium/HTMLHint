define("ace/mode/vbscript",
       [
         ...
         "ace/tokenizer", "ace/mode/vbscript_highlight_rules"
       ],
       function(e, t, n) {
              ...
              s = function() {
                this.$rules = {
                  start : [
                    ...
                    {
                      token : [
                        "storage.type.function.asp", "text",
                        "entity.name.function.asp", "text",
                    ...
                    },
                    {
                      ...
                      regex :
                          "(?:\\b(Application|ObjectContext|Request|Response|Server|Session)\\b)"
                    },
                    {
                    ...
                    },
                    {
                      ...
                      regex :
                          "(?:\\b(Lock|Unlock|SetAbort|SetComplete|BianryRead|AddHeader|AppendToLog|BinaryWrite|Clear|End|Flush|Redirect|Write|CreateObject|HTMLEncode|MapPath|URLEncode|Abandon|Convert|Regex)\\b)"
                    },
                    {
