define(
    ...
    [
      ...
      "ace/mode/javascript", "ace/mode/xml", "ace/mode/html", "ace/tokenizer",
      "ace/mode/markdown_highlight_rules", "ace/mode/folding/markdown"
    ],
    function(e, t, n) {
      var r = e("../lib/oop"), i = e("./text").Mode, s = e("./javascript").Mode,
          o = e("./xml").Mode, u = e("./html").Mode,
          a = e("../tokenizer").Tokenizer,
          f = e("./markdown_highlight_rules").MarkdownHighlightRules,
          l = e("./folding/markdown").FoldMode, c = function() {
            var e = new f;
            this.$tokenizer = new a(e.getRules()), this.$embeds = e.getEmbeds(),
    ...
    define("ace/mode/xml",
           [
             "require", "exports", "module", "ace/lib/oop", "ace/mode/text",
             "ace/tokenizer", "ace/mode/xml_highlight_rules",
           ...
           function(e, t, n) {
             var r = e("../lib/oop"), i = e("./text").Mode,
                 ...
                 a = e("./folding/xml").FoldMode, f = function() {
                   this.$tokenizer = new s((new o).getRules()),
                   this.$behaviour = new u, this.foldingRules = new a
                 };
    ...
    define(
        ...
        [
          "require", "exports", "module", "ace/lib/oop", "ace/mode/xml_util",
          "ace/mode/text_highlight_rules"
        ],
        function(e, t, n) {
          var r = e("../lib/oop"), i = e("./xml_util"),
              s = e("./text_highlight_rules").TextHighlightRules,
              o = function() {
                this.$rules = {
                  start : [
    ...
    define(
        ...
        [
          ...
          "ace/mode/html_highlight_rules", "ace/mode/css_highlight_rules"
        ],
        function(e, t, n) {
          function f(e, t) {
            return {
              token: "support.function", regex: "^```" + e + "\\s*$",
                  next: t + "start"
            }
          }
          var r = e("../lib/oop"),
              ...
              a = e("./css_highlight_rules").CssHighlightRules, l = function() {
                this.$rules = {
                  basic : [
                    {token : "support.function", regex : "(`+)(.*?[^`])(\\1)"},
                    {
                      token : [
                        "text", "constant", "text", "url", "string", "text"
                      ],
                      regex :
                          '^([ ]{0,3}\\[)([^\\]]+)(\\]:\\s*)([^ ]+)(\\s*(?:["][^"]+["])?(\\s*))$'
                    },
                    ...
                    {
                      token : [
                        "text", "string", "text", "markup.underline", "string",
                        "text"
                      ],
                      regex :
                          '(\\[)(\\[[^\\]]*\\]|[^\\[\\]]*)(\\]\\([ \\t]*)(<?(?:(?:[^\\(]*?\\([^\\)]*?\\)\\S*?)|(?:.*?))>?)((?:[ 	]*"(?:.*?)"[ \\t]*)?)(\\))'
                  ...
                  start : [
                    ...
                    {token : "markup.heading.2", regex : "^\\-+(?=\\s*$)"}, {
                      token : function(
                          e) { return "markup.heading." + e.length },
                      regex : /^#{1,6}(?=\s*[^ #]|\s+#.)/,
                      next : "header"
                    },
                    f("(?:javascript|js)", "js-"), f("xml", "xml-"),
                    f("html", "html-"), f("css", "css-"), {
                      token : "support.function",
                      regex : "^```\\s*[a-zA-Z]*(?:{.*?\\})?\\s*$",
                      next : "githubblock"
                    },
                  ...
                  header : [
                    {regex : "$", next : "start"}, {include : "basic"},
                ...
                for (var t in e)
                  this.$rules[t] ? this.$rules[t] = this.$rules[t].concat(e[t])
                                 : this.$rules[t] = e[t];
                this.normalizeRules()
              };
          ...
          r.inherits(o, i), function() {
            ...
            this.getFoldWidget = function(e, t, n) {
              ...
              return this.foldingStartMarker.test(r)
                         ? r[0] == "`" ? e.bgTokenizer.getState(n) == "start"
                                             ? "end"
                                             : "start"
                                       : "start"
                         : ""
