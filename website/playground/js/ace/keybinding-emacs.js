define(
    ...
    [
      ...
      "ace/keyboard/hash_handler", "ace/lib/keys"
    ],
    function(e, t, n) {
      var r = e("../lib/dom"), i = function(e, t) {
        var n = this.scroller.getBoundingClientRect(),
            r = Math.floor((e + this.scrollLeft - n.left - this.$padding) /
                           this.characterWidth),
      ...
      t.handler.attach = function(e) {
        o ||
            (o = !0,
             r.importCssString(
                 ...
                 "emacsMode")),
            u = e.session.$selectLongWords, e.session.$selectLongWords = !0,
            a = e.session.$useEmacsStyleLineStart,
            e.session.$useEmacsStyleLineStart = !0, e.session.$emacsMark = null,
            t.markMode = function() { return e.session.$emacsMark },
            t.setMarkMode = function(t) { e.session.$emacsMark = t },
            e.on("click", l), e.on("changeSession", f),
            e.renderer.screenToTextCoordinates = i, e.setStyle("emacs-mode"),
            e.commands.addCommands(d), t.handler.platform = e.commands.platform
        ...
        delete e.renderer.screenToTextCoordinates,
            ...
            e.unsetStyle("emacs-mode"), e.commands.removeCommands(d)
      };
      var f =
              function(e) {
        e.oldSession && (e.oldSession.$selectLongWords = u,
          ...
          h = {C : "ctrl", S : "shift", M : "alt", CMD : "command"}, p = [
            "C-S-M-CMD", "S-M-CMD", "C-M-CMD", "C-S-CMD", "C-S-M", "M-CMD",
            "S-CMD", "S-M", "C-CMD", "C-M", "C-S", "CMD", "M", "S", "C"
          ];
      p.forEach(function(e) {
        var t = 0;
        e.split("-").forEach(function(e) { t |= c[h[e]] }),
            h[t] = e.toLowerCase() + "-"
      }),
          t.handler
              .bindKey =
     ...
     t.handler.handleKeyboard =
       ...
       typeof a != "string" &&
           (f = a.args, a.command && (a = a.command),
            a === "goorselect" && (a = t.markMode() ? f[1] : f[0], f = null)),
           typeof a == "string" &&
               ((a === "insertstring" || a === "splitline" ||
                 a === "togglecomment") &&
                    t.setMarkMode(null),
                a = this.commands[a] || e.editor.commands.commands[a]),
     ...
     t.emacsKeys = {
       ...
       "Down|C-n" :
           {command : "goorselect", args : [ "golinedown", "selectdown" ]},
       "Left|C-b" :
           {command : "goorselect", args : [ "gotoleft", "selectleft" ]},
       "Right|C-f" :
           {command : "goorselect", args : [ "gotoright", "selectright" ]},
       "C-Left|M-b" : {
         command : "goorselect",
       ...
       "C-Home|S-M-," :
           {command : "goorselect", args : [ "gotostart", "selecttostart" ]},
       "C-End|S-M-." :
           {command : "goorselect", args : [ "gotoend", "selecttoend" ]},
       "S-Up|S-C-p" : "selectup",
       ...
       "C-Up" :
           {command : "goorselect", args : [ "gotopageup", "selectpageup" ]},
       "PageDown|C-v" : {
         command : "goorselect",
         args : [ "gotopagedown", "selectpagedown" ]
       },
     ...
     t.handler.bindKeys(t.emacsKeys), t.handler.addCommands({
       recenterTopBottom : function(e) {
         var t = e.renderer, n = t.$cursorLayer.getPixelPosition(),
             r = t.$size.scrollerHeight - t.lineHeight, i = t.scrollTop;
         Math.abs(n.top - i) < 2
             ? i = n.top - r
             : Math.abs(n.top - i - r * .5) < 2 ? i = n.top
                                                : i = n.top - r * .5,
               e.session.setScrollTop(i)
       },
       selectRectangularRegion : function(
           e) { e.multiSelect.toggleBlockSelection() },
       setMark : function(e) {
         var n = t.markMode();
         if (n) {
         ...
         n = e.getCursorPosition(), t.setMarkMode(n),
       ...
       killWord : {
         exec : function(e, n) {
           e.clearSelection(), n == "left" ? e.selection.selectWordLeft()
       ...
       killRingSave : function(e) { t.killRing.add(e.getCopyText()) },
       keyboardQuit : function(
           e) { e.selection.clearSelection(), t.setMarkMode(null) }
     });
