define("ace/mode/logiql",
       [
         ...
         "ace/tokenizer", "ace/mode/logiql_highlight_rules",
         "ace/mode/folding/coffee", "ace/token_iterator", "ace/range"
       ],
       function(e, t, n) {
         var r = e("../lib/oop"), i = e("./text").Mode,
             ...
             a = e("ace/token_iterator").TokenIterator,
             f = e("ace/range").Range, l = function() {
               var e = new o;
         ...
         r.inherits(l, i), function() {
           ...
           this.getNextLineIndent = function(e, t, n) {
             var r = this.$getIndent(t), i = t.match();
