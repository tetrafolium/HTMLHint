define("ace/mode/abap",
       [
         ...
         "ace/mode/abap_highlight_rules", "ace/mode/folding/coffee",
         "ace/range", "ace/mode/text", "ace/lib/oop"
       ],
       function(e, t, n) {
         function f() {
         ...
         var r = e("../tokenizer").Tokenizer,
             i = e("./abap_highlight_rules").AbapHighlightRules,
             s = e("./folding/coffee").FoldMode, o = e("../range").Range,
             u = e("./text").Mode, a = e("../lib/oop");
         a.inherits(f, u), function() {
           this.getNextLineIndent = function(e, t, n) {
             ...
             for (var s = n; s <= r; ++s) {
               var u = t.getLine(s);
               if (hereComment.test(u)) {
                 continue;
               }
               commentLine.test(u) ? u = u.replace(commentLine, "$1")
                                   : u = u.replace(indentation, "$&#"),
                                     i.end.row = i.start.row = s,
