...
var HTMLHint = function(e) {
  function t(e, t) { return Array(e + 1).join(t || " ") }
  var a = {};
  return a.version = "0.9.13", a.release = "20160501", a.rules = {},
         a.defaultRuleset = {
           "tagname-lowercase" : !0,
           "attr-lowercase" : !0,
         ...
         a.addRule = function(e) { a.rules[e.id] = e },
         a.verify = function(t, n) {
           ...
           a.colors && (r.white = "[37m", r.grey = "[90m", r.red = "[31m",
                        r.reset = "[39m");
           var i = a.indent || 0;
           return e.forEach(function(e) {
             var a = 40, s = a + 20, o = e.evidence, l = e.line, u = e.col,
                 d = o.length, c = u > a + 1 ? u - a : 1,
             ...
             null !== h && (g += h.length),
                 n.push(r.white + t(i) + t((l + "").length + 3 + g) + "^ " +
                        r.red + e.message + " (" + e.rule.id + ")" + r.reset)
           }),
                  n
         }, a
}();
"object" == typeof exports && exports && (exports.HTMLHint = HTMLHint),
    function(e) {
      ...
      t.prototype = {
        ...
        error : function(e, t, a, n, r) { this.report("error", e, t, a, n, r) },
        warn : function(e, t, a, n,
                        r) { this.report("warning", e, t, a, n, r) },
        info : function(e, t, a, n, r) { this.report("info", e, t, a, n, r) },
...
var HTMLParser = function(e) {
  ...
  return t.prototype = {
    _init : function() {
      var e = this;
      e._listeners = {}, e._mapCdataTags = e.makeMap("script,style"),
...
"object" == typeof exports && exports && (exports.HTMLParser = HTMLParser),
    HTMLHint.addRule({
      ...
      init : function(e, t) {
        ...
        e.addListener("tagstart", function(n) {
          var r, i = n.tagName.toLowerCase(), s = e.getMapAttrs(n.attrs),
                 o = n.col + i.length + 1;
          "img" !== i || "alt" in s
              ? ("area" === i && "href" in s ||
                 "input" === i && "image" === s.type) &&
                    ("alt" in s && "" !== s.alt ||
                     (r = "area" === i ? "area[href]" : "input[type=image]",
                      t.warn("The alt attribute of " + r +
                                 " must have a value.",
                             n.line, o, a, n.raw)))
              : t.warn("An alt attribute must be present on <img> elements.",
                       n.line, o, a, n.raw)
        })
      }
    }),
      ...
      init : function(e, t, a) {
        ...
        e.addListener("tagstart", function(e) {
          for (var a, i = e.attrs, s = e.col + e.tagName.length + 1, o = 0,
            ...
            a = i[o];
            var u = a.name;
            -1 === r.indexOf(u) && u !== u.toLowerCase() &&
                t.error("The attribute name of [ " + u +
              ...
              try {
                ...
                o.forEach(function(e) {
                  ...
                  t["warning" === e.type ? "warn" : "error"](
                      "[" + e.rule.id + "] " + e.message, i + a,
                      (1 === a ? s : 0) + e.col, n, e.evidence)
                })
              } catch (l) {
              }
            }
    ...
    HTMLHint.addRule({
      ...
      init : function(e, t) {
        var a = this, n = function(r) {
          "start" === r.type || "text" === r.type && /^\s*$/.test(r.raw) ||
              (("comment" !== r.type && r.long === !1 ||
                /^DOCTYPE\s+/i.test(r.content) === !1) &&
                   t.error("Doctype must be declared first.", r.line, r.col, a,
                           r.raw),
    ...
    HTMLHint.addRule({
      ...
      init : function(e, t) {
        function a(e) {
          e.long === !1 && "doctype html" !== e.content.toLowerCase() &&
              t.warn('Invalid doctype. Use: "<!DOCTYPE html>"', e.line, e.col,
                     r, e.raw)
        }
        function n() {
    ...
    HTMLHint.addRule({
      ...
      init : function(e, t) {
        function a(a) {
          var n = e.getMapAttrs(a.attrs), o = n.type,
              l = a.tagName.toLowerCase();
          "head" === l && (s = !0),
              s !== !0 || "script" !== l || o && i.test(o) !== !0 ||
                  t.warn("The <script> tag cannot be used in a <head> tag.",
                         a.line, a.col, r, a.raw)
        }
        function n(t) {
          "head" === t.tagName.toLowerCase() &&
              (e.removeListener("tagstart", a), e.removeListener("tagend", n))
        }
        var r = this, i = /^(text\/javascript|application\/javascript)$/i,
            s = !1;
            ...
            if (a = i[o], "href" === a.name) {
              ("absolute" === r && /^\w+?:/.test(a.value) === !1 ||
               "relative" === r && /^https?:\/\//.test(a.value) === !0) &&
                  t.warn("The value of the href attribute [ " + a.value +
                             " ] must be " + r + ".",
                         e.line, s + a.index, n, a.raw);
              break
            }
          ...
          for (var r, i, s = e.attrs, o = e.col + e.tagName.length + 1, l = 0,
            ...
            if (r = s[l], "id" === r.name.toLowerCase()) {
              ...
              i && (void 0 === n[i] ? n[i] = 1 : n[i]++,
                    n[i] > 1 &&
                        t.error("The id value [ " + i + " ] must be unique.",
            ...
            if (o = "object" == typeof exports && require
              ...
              try {
                ...
                c === !1 && o.errors.forEach(function(e) {
                  var a = e.line;
                  t.warn(e.reason, l + a, (1 === a ? u : 0) + e.character, n,
                         e.evidence)
                })
              } catch (f) {
              }
        ...
        e.addListener("text", function(a) {
          for (var s, o = a.raw, l = /(^|\r?\n)([ \t]+)/g; s = l.exec(o);) {
            ...
            if (1 === u.col) {
              var d = s[2];
              "space" === r
                  ? i ? (/^ +$/.test(d) === !1 || 0 !== d.length % i) &&
                            t.warn(
                                "Please use space for indentation and keep " +
                                    i + " length.",
                                u.line, 1, n, a.raw)
                      : /^ +$/.test(d) === !1 &&
                            t.warn("Please use space for indentation.", u.line,
                                   1, n, a.raw)
                  : "tab" === r && /^\t+$/.test(d) === !1
                        ? t.warn("Please use tab for indentation.", u.line, 1,
                                 n, a.raw)
                        : / +\t|\t+ /.test(d) === !0 &&
                              t.warn(
      ...
      init : function(e, t) {
        ...
        e.addListener("text", function(n) {
          for (var r, i = n.raw, s = /[<>]/g; r = s.exec(i);) {
            ...
            t.error("Special characters must be escaped : [ " + r[0] + " ].",
                    o.line, o.col, a, n.raw)
          }
        })
      }
    }),
    ...
    HTMLHint.addRule({
      ...
      init : function(e, t) {
        ...
        e.addListener("tagstart", function(e) {
          ...
          for (var r = e.tagName.toLowerCase(), i = n.length - 1;
               i >= 0 && n[i].tagName !== r; i--)
            ;
          if (i >= 0) {
          ...
          if (r.length > 0) {
            ...
            t.error("Tag must be paired, missing: [ " + r.join("") +
                        " ], open tag match failed [ " + s.raw + " ] on line " +
                        s.line + ".",
                    e.line, e.col, a, "")
          }
        })
    ...
    HTMLHint.addRule({
      ...
      init : function(e, t) {
        ...
        e.addListener("tagstart", function(e) {
          ...
          void 0 !== n[r] && (e.close || t.warn("The empty tag : [ " + r +
                                                    " ] must be self closed.",
                                                e.line, e.col, a, e.raw))
        })
      }
    ...
    HTMLHint.addRule({
      ...
      init : function(e, t) {
        ...
        e.addListener("tagstart,tagend", function(e) {
          var n = e.tagName;
          n !== n.toLowerCase() && t.error("The html element name of [ " + n +
                                               " ] must be in lowercase.",
                                           e.line, e.col, a, e.raw)
        })
      }
